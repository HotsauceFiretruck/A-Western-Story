...
export class Bullet
{
    constructor(scene, target, fromX, fromY, toX, toY)
    {
        ...
        this.sprite = scene.matter.add.sprite(fromX-1, fromY, 'bullet');
        this.sprite = scene.matter.add.sprite(fromX, fromY-1, 'bullet');
        this.sprite = scene.matter.add.sprite(fromX+1, fromY, 'bullet');
        this.sprite = scene.matter.add.sprite(fromX, fromY+1, 'bullet');
        this.sprite = scene.matter.add.sprite(fromX-2, fromY, 'bullet');
        this.sprite = scene.matter.add.sprite(fromX, fromY-2, 'bullet');
        this.sprite = scene.matter.add.sprite(fromX+2, fromY, 'bullet');
        this.sprite = scene.matter.add.sprite(fromX, fromY+2, 'bullet');
        this.sprite = scene.matter.add.sprite(fromX, fromY, 'bullet');
        this.sprite = scene.matter.add.sprite(fromX, fromY, 'bullet');
